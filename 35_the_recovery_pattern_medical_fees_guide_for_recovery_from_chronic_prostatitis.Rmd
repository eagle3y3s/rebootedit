...
Starts to reboot -> withdrawal symptoms (appears within a month) -> period for repeated symptoms (appears after a few months of rebooting) -> persists in rebooting and health cultivation (including active treatment) -> reduced frequency in repeated symptoms -> approaching recovery -> recovery.
